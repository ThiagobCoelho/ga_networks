...
if __name__ == "__main__":
	...
	block_table_ga = np.zeros((info.SIM_MAX_LOAD-1,num_nodes,2))
	block_table_alt = np.zeros((info.SIM_MAX_LOAD-1,num_nodes,2))
	block_table_fix = np.zeros((info.SIM_MAX_LOAD-1,num_nodes,2))
...
#		print '\tSTA: ', blocked_std_alt
	...
	with open('block_GA_{}_{}.m'.format(top,str(node)), 'a') as f:
